...
$(document).ready(function(){
  ...
  $("#footer img:nth-of-type(1)").click(function(){
  window.location = 'https://www.facebook.com/ieeedtu';
});

$("#footer img:nth-of-type(2)").click(function(){
  window.location = 'https://twitter.com/ieeedtu';
});

$("#footer img:nth-of-type(3)").click(function(){
  window.location = 'https://dtuieee.wordpress.com/';
});

$("#footer img:nth-of-type(4)").click(function(){
  window.location = 'https://www.youtube.com/user/ieeedtu';
});
});